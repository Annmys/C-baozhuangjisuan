namespace 包装计算
{
        ...
        private List<新包装资料> 装箱产品列表 = new List<新包装资料>
    {
        ...
        {
            var 包装资料 = 装箱产品列表
                .FirstOrDefault(包装 => 包装.装箱产品型号.Contains(产品型号) &&
                                         包装.装箱产品类型.Any(类型 => 类型.Contains(产品类型)));
            return 包装资料;
        }
    }
